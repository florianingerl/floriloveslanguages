...
<ol>
<li>The friend of Brian is called Katy.</li>
...
In the hospital, Brian had the opportunity to meet very nice nurses who took good care of him while he was being examined. 
He even became friends with one of them.
<VueExercise lg="en" :topics="['In case']" instruction="Some things Brian might need in the hospital are given. Form sentences using in case like in the example!">
...
Her name was Sonja and her blue eyes were as beautiful as the moon. Or at least, 
Brian forgot completely about his broken limb when he looked at her smile.
Although Katy was glad that Brian got the help he needed, she was not that pleased and frowned upon his new friendship 
...
I'm trying to protect you!" said Katy when Brian didn't believe her.

<VueExercise lg="en" :topics="['Plural or singular']" instruction="Fill in the gaps by either the plural or the singular!">
<VueMCGaps lg="en" :gaptexts="['{The health|The healths} of the patients in a hospital is often bad and gets worse there.',
'Sonja wants to be mentioned in her patients\' {testament|testaments}.',
'{The brain|The brains} of some doctors is presumably rather small because they always treat {their patients|their patient} with poison.']" >

</VueMCGaps>
</VueExercise>

But Brian didn't really listen to this nonsense and itched to bond with Sonja whose eyes he was in love with.
Katy was used to Brian not listening to her but she was stubborn and decided to investigate about Sonja to make sure 
...
So Katy had to hurry if she wanted to prevent his friend falling completely in love with Sonja.

<VueExercise lg="en" :topics="['Inverted conditional sentences']" instruction="Form correct inverted conditional sentences!">
<VueMCGaps lg="en" :gaptexts="['{Were Katy to tell|Would Katy tell} the truth, she would confess her love to Brian.',
'{Should Sonja need money|If Sonja needs money}, she just needs to wait until one of her partients dies and make sure that she\'s mentioned in the testament.',
'{Had Brian not fallen|If Brian has not fallen} off the tree, he wouldn\'t have met Sonja.']">

</VueMCGaps>
</VueExercise>

That first old patient Katy talked to had once been a breathtaking young women, but not any more after she had fallen face foward
 from a tree and had arrived at the hospital with her face covered with scars and blue and yellow bruises.


<VueExercise lg="en" :topics="['Vocabulary on a tree']" instruction="Fill in the gaps by the correct word that has something to do with trees!">
<VueMCGaps lg="en" :same="true" :gaptexts="['In automn, the {leaves|} fall off the trees.',
'With its {roots|}, the tree pulls water out of the ground.',
'The older a tree is, the more rings its {trunk|} has.',
'A lot of {branches|} are connected to the trunk of a tree.',
'You call a very small branch a {twig|}.' ]">
...
export default defineComponent ({
  ...
  mounted(){
     console.log("The mounted function of VueRawFood was called!");
