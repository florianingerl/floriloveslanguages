<template>
    <div>
        ...
        "Mais comment le poisson est-il venu à la place centrale?" se demanda Antoine. Dans toute la ville, il n'y a ni
        lac ni même piscine.
        Malgré ses interrogations concernant la venue du poisson jusqu'ici, Antoine ne pouvait s'empêcher d'admirer ce
        merveilleux poisson
        qui trônait là, tel un trophée. Qui l'avait donc pêché? Ou se pouvait-il qu'il était venu seul jusqu'ici?
        <VueExercise lg="fr" :topics="['Questions']" instruction="Forme des questions à partir de la reponse!">
            <p>Exemple:Antoine a quinze ans. -> Quel âge a Antoine?</p>
            <ol>
                <li>
            ...
            <HideShow lg="fr">
                <li>Où vivent les poissons?</li>
                <li>Quand a le monument été construit?</li>
                <li>Quel couleur a le poisson du monument?</li>
        ...
        "Karl 2m", ce qui signifiait probablement que c'était soit l'homme qui avait pêché le poisson qui s'appelait
        Karl
        ou soit le poisson lui-même.
        ...
        Dans ses souvenirs, le voyage du poisson vagabond Karl commençait en pleine mer où le petit Karl était capturé
        par des pirates
        ayant très faim.
        Bien qu'Antoine n'ait jamais vu Karl petit, il pouvait tout de même s'imaginer à quel point il avait dû être
        mignon. Il en fut tout ému.
        Mais ce n'était pas grâce à son apparence mignonne que les pirates ne l'avaient pas mangé. Qu'est qui s'était
        passé?
        <VueExercise lg="fr" :topics="['Pronoms interrogatifs']"
            instruction="Remplis les trous par le pronom interrogatif qui convient!">
            <MCGaps lg="fr" :gaptexts="['{Qui} a capturé le petit poisson Karl? Des pirates.',
                '{Pourquoi} les pirates n\'ont-ils pas mangé Karl? Parce que celui-ci s\'est échappé d\'une manière ou d\'une autre.',
                '{Combien} de pirates y avait-il dans le bateau? Il y avait 30 pirates.'
            ]">
        ...
        <img style="float: right; height: 200px" src="@/assets/img/francais/poisson.png"></img>
        En réalité, les pirates avaient abondamment pillé un navire de marchandises qui contenaient des centaines et des
        centaines d'oeufs.
        Ils avaient donc mangé toutes sortes de préparations à base d'oeufs, telles que des omelettes, oeufs brouillés,
        oeufs au plat, oeufs pochés,
        oeufs mimosa etc.
        C'est pourquoi leur ventre n'avait plus d'espace pour Karl et le voyage de Karl pouvait donc continuer.
        ...
        Quelle chance ! pensa Karl dont la vie fut sauvée grâce à des poules inconnues.
        D'autant plus que le particulier chez lequel il logeait à présent était visiblement plein d'admiration pour
        Karl,
        ce qui flattait incroyablement son égo!
        L'homme s'appelait Monsieur Ibrahim et tenait un petit magasin où il vendait des choses diverses.
        Ce qui empêchait Monsieur Ibrahim d'infliger du mal à Karl était sa foi.
        <VueExercise lg="fr" :topics="['Qui, que ou où']" instruction="Remplis les trous par qui, que ou où!">
            <MCGaps lg="fr" :gaptexts="['Les pirates {qui} avaient épargné la vie de Karl continuaient à préférer les oeufs aux poissons.',
                'Le magasin {que} tenait Monsieur Ibrahim se situait dans une rue populaire au centre de Paris.',
                'Monsieur Ibrahim est vegetarien depuis longtemps et ne peux plus se rappeler de la dernière fois {où} il a mangé un poisson.'
            ]">

            </MCGaps>
        </VueExercise>

        Dans son Koran, Monsieur Ibrahim avait lu qu'il ne faut surtout pas infliger du mal à n'importe quelle créature.
        Mais étant donné que Monsieur Ibrahim était aussi un bon marchant et savait qu'il faut acheter au prix bas et
        vendre cher,
        ...
        <img style="float: right; height: 200px" src="@/assets/img/francais/poisson.png"></img>
        Un jour, un potentiel acheteur se présenta au magasin de Monsieur Ibrahim et déclara vouloir acheter Karl;
        ...
        Du coup, Karl n'était pas encore vendu.
        La même chose se produisit avec d'autres propriétaires de restaurants et aussi avec des particuliers qui avaient
        une figure grosse
        et mangeaient probablement déjà trop de poissons (c'était au moins ce que jugeait Monsieur Ibrahim ). Mais Karl
        voulait être libre.
        "Comment est-ce que je peux m'enfuir de l'aquarium et atteindre la mer ou au moins un lac où l'eau est plus
        ...
        <img style="float: right; height: 200px" src="@/assets/img/francais/poisson.png"></img>
        Cette interrogation l'occupa pendant une grande partie de la journée, puis surgit dans son esprit une idée de
        génie.
...
<MCGaps lg="fr" :gaptexts="['Le poisson Karl a {failli} mourir dans l\'eau sale, mais heureusement, Monsieur Ibrahim l\'a sorti à temps de l\'aquarium.',
    'Il {faut} que Karl revienne à la mer pour y être plus heureux.'
        ...
        nager dans le lac , retrouver ses amies les algues, les maquereaux, les tritons, tout cela le réjouit au plus
        haut point.
...
<MCGaps lg="fr" :gaptexts="['Le poisson Karl nage {jusqu\'à|bien que} ce que Monsieur Ibrahim {relâche} (relâcher) le filet.',
    ...
    '{À condition que|Bien que} Karl {soit} (être) plus fort que Monsieur Ibrahim, il va s\'enfuir dans le lac.'
        ...
        se laisserait pas faire, mais à ce point-là! Quelle force, quelle puissance!
